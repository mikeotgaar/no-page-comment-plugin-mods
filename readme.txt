...
= 1.0.2 beta =
* FIX: Renamed CSS classes to prevent conflict with WordPress core CSS classes  (mikeotgaar)
...
= 1.0.2 beta =
Proposed fixes for CSS classes. Give classes unique names to prevent conflicts with WordPress core classes
